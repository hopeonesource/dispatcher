...
class HosMessageManagerForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'dispatcher_settings_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('dispatcher.hosmessagemanager');
    ...
    $form['dispatcher']['tropo_base_url'] = array(
      '#type' => 'textfield',
      '#title' => $this->t('Tropo base url'),
      '#default_value' => $config->get('tropo_base_url'),
      '#required' => TRUE,
    );
    $form['dispatcher']['access_token'] = array(
      '#type' => 'textfield',
    ...
    $form['dispatcher']['sms_count'] = array(
      '#type' => 'textfield',
    ...
    $form['dispatcher']['sms_time_between_texts'] = array(
      '#type' => 'textfield',
    ...
    $form['dispatcher']['sms_testing'] = array(
      '#type' => 'checkbox',
    ...
    $form['dispatcher']['sms_logging'] = array(
      '#type' => 'checkbox',
    ...
    $form['dispatcher']['default_message'] = array(
      '#type' => 'textarea',
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->config('dispatcher.hosmessagemanager')
